...
export default function TopClientSection({
  ...
  return (
    <>
      {/* PART 1: Top Clients Compact Overview (6 Logo Grid - Guaranteed 100% Visible) */}
      <section
        id="top-clients"
        className="w-full min-h-[60vh] flex flex-col justify-center bg-[#121212] text-white py-20 px-6 md:px-12 lg:px-[80px] border-t border-b border-white/5 relative overflow-hidden"
      >
        <div className="max-w-[1440px] mx-auto w-full space-y-12">
          ...
          {/* 6 Partner Logos Grid (Monochrome SVG logos) */}
          <div className="py-8 max-w-5xl mx-auto w-full">
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-10 md:gap-12 items-center justify-items-center">
              {clientLogos.map((client, idx) => (
                ...
                >
                  <div className="relative h-12 md:h-14 w-full max-w-[160px] opacity-85 hover:opacity-100 transition-opacity">
                    <Image
                      src={client.src}
                      alt={client.name}
                      fill
      ...
      {/* PART 2: Expanded Detail Cards (Featured Projects Detailed Sequence) */}
      <section
        id="featured-projects"
        className="w-full bg-[#121212] text-white py-24 px-6 md:px-12 lg:px-[80px] border-b border-white/5 relative overflow-hidden"
      >
        <div className="max-w-[1440px] mx-auto w-full space-y-32">
