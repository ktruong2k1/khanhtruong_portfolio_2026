    ...
    >
      ...
      <div className="sticky top-0 h-screen overflow-hidden flex items-center px-6 md:px-12 lg:px-[80px]">
        <div className="max-w-[1440px] mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-center h-full py-16">
          ...
          <div className="lg:col-span-4 flex flex-col justify-between h-full max-w-md z-10 pr-6 min-w-0">
            <div className="space-y-8 my-auto w-full">
              <p className="font-mono text-base md:text-xl font-normal leading-relaxed text-white/90 w-full block whitespace-normal">
                {lang === "vi"
              ...
              <p className="font-sans text-white/70 text-sm md:text-base leading-relaxed w-full block whitespace-normal">
                {lang === "vi"
          ...
          <div className="lg:col-span-8 overflow-hidden h-full flex items-center min-w-0">
