    ...
    <>
      ...
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ease-out ${
          isScrolled
            ? "w-full bg-[#121212]/80 backdrop-blur-xl border-b border-white/10 py-3 px-6 md:px-12 lg:px-[10vh] pointer-events-auto shadow-2xl"
            : "pt-[40px] md:pt-[60px] px-6 md:px-12 lg:px-[10vh] pointer-events-none"
        }`}
      >
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-50 bg-[#121212]/95 backdrop-blur-2xl flex flex-col justify-between p-6 md:p-12 lg:px-[10vh] lg:py-[40px]"
          >
            {/* Top Modal Header */}
